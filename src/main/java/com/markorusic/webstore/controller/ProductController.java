...
public class ProductController {
    ...
    public Page<Product> findAll(@QuerydslPredicate(root = Product.class, bindings = ProductDao.class) Predicate predicate, Pageable pageable) {
    ...
    public Product save(@Validated(ValidationGroup.Save.class) @RequestBody ProductRequestDto productRequestDto) {
        return productService.save(productRequestDto);
    }

    @RequestMapping(value = "/update", method = RequestMethod.PUT)
    @ApiOperation(value = "Method for updating existing product")
    public Product update(@Validated(ValidationGroup.Update.class) @RequestBody ProductRequestDto productRequestDto) {
